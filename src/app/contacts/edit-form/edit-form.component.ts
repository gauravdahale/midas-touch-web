...
export class EditFormComponent {
    ...
    if (data.length > 0) {
      data.forEach(it => {
        const fb = this.fb.group({
          ...
          type: this.fb.control(it.type, Validators.required)
        })
  ...
  private initFormWithData(mData: Contacts) {
    this.formGroup = this.fb.group({
      prefix: new FormControl(mData.prefix, Validators.required),
      firstName: new FormControl(mData.firstName, Validators.required),
      middleName: new FormControl(mData.middleName, Validators.required),
      lastName: new FormControl(mData.lastName, Validators.required),
      reference: new FormControl(mData.reference, Validators.required),
      event: new FormControl(mData.event, Validators.required),
      significantDate: new FormControl(mData.significantDate, Validators.required),
      gender: new FormControl(mData.gender, Validators.required),
      location: new FormControl(mData.gender, Validators.required),
      language: new FormControl(mData.language, Validators.required),
      hobby: new FormControl(mData.hobby, Validators.required),
      tags: new FormControl(mData.tags, Validators.required),
      notes: new FormControl(mData.notes, Validators.required),
      ...
      individual: new FormControl(this.mData.individual),
      nonindividual: new FormControl(this.mData.nonindividual),
      representative: new FormControl(this.mData.representative),
      staff: new FormControl(this.mData.staff),
      personal: new FormControl(this.mData.personal),
      office: new FormControl(this.mData.office),
      agetnStatus: new FormControl(this.mData.agetnStatus),
      status: new FormControl(this.mData.status),
      mainDistributorName: new FormControl(this.mData.mainDistributorName),
      service: new FormControl(this.mData.service),
      mainAgentCode: new FormControl(this.mData.mainAgentCode),
      representativeNote: new FormControl(this.mData.representativeNote),
      activeStatus: new FormControl(this.mData.activeStatus),
      euin: new FormControl(this.mData.euin),
      subAgentName: new FormControl(this.mData.subAgentName),
      userId: new FormControl(this.mData.userId),
      password: new FormControl(this.mData.password),
